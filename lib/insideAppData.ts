...
• 	IBC Chapter 12 requires that interior spaces meet minimum ventilation standards.
...
• 	IBC 1009.8  If your common area is not an Area of Refuge → no call‑for‑aid required.
`
        },
        {
            id: 'call_aid_2',
...
🧪 Step 3: Functional Testin                                                                                                                                                       • 	Test Button Activation:
...
• 	Battery-only alarms permitted if the  at time of construction allowed it
...
• 	Near the t duct register if served by a remote furnace
...
• 	Minimum Ceiling Height — IBC 1208.2 & 1003.2
Common areas (corridors, lobbies, community rooms, laundry rooms, mailrooms) must meet:
Habitable/common rooms
7 ft 6 in minimum ceiling height (IBC 1208.2)
Corridors/egress paths
7 ft 6 in minimum (IBC 1003.2)
Projections (lights, ducts, sprinklers) allowed down to 6 ft 8 in`
        },
        {
            id: 'ceiling_2',
            name: 'Ceiling has a hole.',
...
• 	IBC 2113.19   Minimum clearances:                                                                                                                                                                         2 inches (51 mm) from combustibles for interior masonry chimneys
1 inch (25 mm) for chimneys entirely outside the exterior wall
Clearance cannot be filled except where fire blocking is permitted (IBC 2113.20)`
        }
    ]
};
...
IBC → IMC 504 governs dryer exhaust systems
IBC 2901.1 and 1203 send all dryer ventilation requirements to the International Mechanical Code (IMC).
Independent exhaust duct (no combining with bathrooms or other dryers unless listed manifold system)
Exhaust to the outdoors only
Smooth metal duct, min 0.016" thick
Maximum duct length 35 ft (before reductions for elbows)
No screens at termination
Backdraft damper required
Transition duct max 8 ft, listed and labeled`
        },
        {
            id: 'dryer_2',
            name: 'Electrical dryer exhaust ventilation has restricted airflow.',
...
• 	IBC Chapter  7                                                                                                                     A common‑area entry door must be fire‑rated if it is part of a required fire‑resistance‑rated assembly.                                                                                              Typical cases where a rating is required:
Door from a corridor that is rated
Door into a stair enclosure (1‑ or 2‑hour)
Door into a shaft enclosure
Door into a fire‑rated lobby (high‑rise)`
        },
        {
            id: 'door_fire_2',
...
📏 Step 4: Accessibility Accessibility Requirements — IBC Chapter 11
All common‑area doors must be fully accessible:
32" clear width
Maneuvering clearances on push/pull sides
Accessible hardware
Threshold ≤ ½ inch (beveled)
...
• 	IBC Chapter 10 performance
A general door in a common area of an R‑2 building must be:
32" × 80" minimum clear opening
Accessible (hardware, clearances, thresholds)
Fire‑rated and self‑closing only if in a rated wall
Out‑swinging if serving 50+ occupants
Openable without keys/tools`
        },
        {
            id: 'door_general_2',
            name: 'A passage door (door into utility room, storage or closet room, or laundry room) does not open.',
...
📏 Step 4: Accessibility (IBC Chapter 11)
If the garage door leads to a common‑use area, the personnel door must be:
Accessible
Have compliant hardware
Have maneuvering clearances
Threshold ≤ ½ inch
Vehicular overhead doors are not required to be accessible.
⚒️ Step 5: IRC Structural & Safety Requirements
...
• 	IBC 2901.1 – All drains must comply with the IPC
...
• 	(IBC §1031.2)EEROs must open directly to a public way, or a yard/court that leads to a public way.
...
• 	IBU Overlay: May require audible exit alerts, tactile signage, or seismic bracing                                          ⚒️ Step 5: IRC Egress Requirements
• 	IRC (2021) §R311.1–R311.4 – Means of egress.
 IRC ensures that egress systems are structurally sound, code-compliant, and safe for emergency
...
• 	IBU overlays – Local fire, shock hazard, and accessibility code GFCI protects against electrical shock; AFCI protects against fire caused by arc faults. Both are required in specific zones per IRC and NSPIRE
...
• 	IBC to NEC: In modern NEC cycles, almost every receptacle in a dwelling unit is GFCI‑protected except bedroom general outlets.                                       
...
• 	IBU Local Codes: Location & Access (IBC 1023, 1001, 1003)                            Service panels cannot be installed in:
Exit enclosures (stairwells)
Exit passageways
Fire‑rated egress corridors (unless allowed by local amendments)s
⚒️ Step 5: IRC Electrical Requirements
Codes Referenced:
    ...
    deficiencies: [
        {
            ...
            code: 'ELEVATOR-01',
            codeReference: `
🧭 Step 1: Identify Elevator Type and Location
...
⚒️ Step 5: IRC Structural & Safety Requirements
• 	IRC R321.1:
• 	Elevators must comply with ASME A17.1 safety code
• 	IRC E3701.1:
• 	Electrical systems must be grounded and protected
• 	IRC R311.4:
• 	Egress routes must include accessible vertical transport if required
• 	IRC R314 & R315:
• 	Smoke and CO alarms must not interfere with elevator operation
...
• 	Verify presence: A smoke alarm must be installed on every level of the building, including common areas.       🔍 Step 2: Visual Condition Assessment
• 	Painted surface
• 	Stickers or decorations, • 	Obstructions (e.g., dust, cobwebs, furniture)
🧪 Step 3: Functional Testing, the central alarm system must be certified annually.
...
If the alarm does not activate or is silent, it must be cited as inoperable and corrected within 24 hours. If no certificate is available
...
• 	IBC + NFPA 72 Interaction
IBC tells you where detection is required.
NFPA 72 tells you how to install it.
Examples: Spacing, Sensitivity, Placement near HVAC
 visual alarms for hearing-impaired residents
⚒️ Step 5: IRC Installation Requirements
...
- Sprinkler assemblies must be installed and maintained per IBC + IFC + NFPA 13/13R.
⚒️ Step 5: IRC Fire Safety Requirements
...
All systems must be tested, supervised, and maintained (IBC 901.5–901.6)`
        },
        {
            id: 'fire_sprinkler_2',
            name: 'Sprinkler head assembly has evidence of corrosion.',
...
• 	IBU Local Codes: May require non-slip finishes, fire-rated underlayment.                                                                                                                   • 	Surface Stability: No loose tiles, torn carpet, or uneven surfaces
...
• 	Floor Finishes in Common Areas (IBC 804)
IBC regulates finish materials, not the structural floor.
...
• 	Foundation Walls (IBC 1807)(e.g., around stairwells or lobbies) must be dampproofed at minimum.
⚒️ Step 5: IRC Structural Requirements
• 	IRC R401–R404:
• 	Foundations must support loads and resist movement
...
• 	IBC sends you to ICC A117.1, which contains the actual dimensions.
A. Side Wall Grab Bar (Toilet)
42" minimum length
Mounted 12" max from rear wall
Height: 33"–36" AFF
B. Rear Wall Grab Bar
36" minimum length
Extends 12" minimum from centerline on one side and 24" minimum on the other
Height: 33"–36" AFF
`
        }
    ]
...
• 	Dropping Identification: Rodent droppings: rice-sized, pointed ends
...
• 	Infestation is considered a sanitation hazard under the IBC/IFC framework.
`
        },
        {
            id: 'hazard_infest_2',
...
• 	IBU Local Codes: May mandate daily janitorial logs or pest control coordination• 	IRC R306.1:
• 	Buildings must have sanitary waste disposal systems
⚒️ Step 5: • 	Litter & Discarded Items Inspection – Common Area (No Prep / No Access Protocol)
...
• IBC governs where HVAC is allowed and how it interacts with fire‑safety and ventilation, while the IMC governs the technical installation.
`
        },
        {
            id: 'hvac_2',
...
• 	IBU Overlay: May require multilingual signage, tactile controls, or safety instructions                                  ⚒️ Step 5: IRC Installation & Safety Requirements
...
📏 Step 4: 6. Accessibility & Local Requirements
...
• 	Under sinks and inside cabinets, around dishwashers or refrigerators, behind or under cooking appliances • 	On walls, ceilings, or backsplashes near cooking steam
🔍 Step 2: Visual Condition Assessment                                                                                                       Irregular patches or spots that are white, green, yellow, gray, brown, or black; may appear fuzzy, fussy or slimy          🧪 Step 3: Inspection Technique
...
• 	IBC 1201 – Interior Environment
Requires interior spaces to maintain conditions that do not create hazards.
`
        },
        {
            id: 'kitchen_mold_2',
...
• IBU overlays – Local health, food safety, and accessibility codes`
        },
        {
            ...
            codeReference: `🧭 Step 1: Presence & Identification
• 	Required if: The space is designated or used as a kitchen or food prep zone.
• 	Appliance type: Standard refrigerator with built-in freezer                                                                              🔍 Step 2: Visual Condition Assessment
• 	Cooling test: Confirm refrigerator maintains 32–40°F and freezer <32°F
• 	Power check: Unit must be plugged in and running (audible compressor or internal light)                          🧪 Step 3: Functional Testing
• 	Cooling Test: Open refrigerator and freezer doors; feel for cold air
• 	Confirm freezer maintains temperature below 32°F
• 	Refrigerator should be between 32°F and 40°F
• 	Component Check: Inspect shelves, drawers, seals, and lightbulbs for damage
...
• 	IRC Requirement: Sink must provide hot and cold water and be connected to a sanitary sewer or approved private sewage system.                                                                                                                                    🔍 Step 2: Visual Condition Assessment
...
• 	Through-wall fan venting directly outside                                                                                                           🔍 Step 2: Visual Condition Assessment
• 	Inspect intake area: Ensure no grease buildup, debris, or physical blockage.
• 	Check filters: Must be clean and properly seated                                                                                               🧪 Step 3: Functional Testing
...
• 	IBC Code IBC Ch. 29 – Sewage/Drain Leak in Common Area
`
        },
        {
            id: 'kitchen_vent_2',
...
Gas/propane Leak-Smell (e.g., rotten egg odor from mercaptan), 
Oil leak -Oil stains or pooling
🧪 Step 3: Inspection Technique
...
⚒️ Step 5: IRC Fuel System Requirements - IRC G2415.1–G2415.17:
- Fuel gas piping must be sealed, supported, and protected from damage
...
• 	IBC Chapter 14 – Exterior Walls (Water Intrusion)
Exterior walls must prevent:
Water penetration
...
• 	IIBC + NFPA 101/70 Interaction
IBC governs where emergency lighting is required.
NFPA 70 (NEC) governs how it is wired.
Key NEC rules:
Emergency circuits must be separately identified
Must be on dedicated emergency branch circuits
Must not share circuits with normal lighting
`
        }
    ]
};
    ...
    deficiencies: [
        {
            ...
            points: '5.0/n',
            code: 'MOLD-01',
            codeReference: `🧭 Step 1: Identify Mold -Like substance
Early‑Stage Mold (Light Growth)
Thin, powdery discoloration
Colors: light gray, pale green, or faint brown
Appears like dust that doesn’t wipe away easily
🔍 Step 2: Visual Condition Assessment
...
• 	IRC R307.2/(IBC [P] 1210.2.4): Shower walls must be finished with nonabsorbent material to ≥6 ft above floor
• 	IRC R317.1: Moisture-prone areas must use decay-resistant materials.
`
        },
        {
...
• 	Mounting Check: Gently press sink edges to confirm secure installation
📏 Step 4: Accessibility & Disability  Considerations. "IBU"                                                                      • 	Height: Sink rim should be ≤34" AFF for accessible use
• 	Knee Clearance: Minimum 27" high × 30" wide × 11" deep under sink
• 	Reach Range: Faucet controls must be within 15"–48" AFF
• 	Operability: Controls must be usable with one hand, no tight grasping or twisting
• 	Clear Floor Space: Minimum 30"x48" in front of sink
⚒️ Step 5: IBC Section 1210 - Installation Requirements
• 	IRC P2705.1: Sinks must be securely mounted and properly connected to water and drain systems
...
⚒️ Step 5:IBC Section 1210  Installation Requirements
• 	IRC P2705.1:
Toilets must be securely mounted and properly connected to water and waste systems
• 	IRC P2601.2:
Drainage must prevent backflow and siphoning
• 	IRC R317.1:
Moisture-prone areas must use decay-resistant materials
`
        },
        {
            id: 'restroom_toilet_2',
...
- IRC M1507.2: Exhaust systems must vent to the outdoors and be sealed
IBC 1202.1 requires that every building (except detached 1–2 family dwellings) must be provided with:
Natural ventilation per IBC 1202.5, OR
Mechanical ventilation per the International Mechanical Code (IMC)`
...
• 	Leak Inspection: Check under the sink for moisture, stains, or active drips
• 	Mounting Check: Gently press sink edges to confirm secure installation.
📏 Step 4: Accessibility - Common‑area sinks are NOT required
But if provided, they must meet all IBC/IPC requirements
Laundry rooms often require a service sink for maintenance staff (IBC 2902.3) 
• 	Clear Floor Space: Minimum 30"x48" in front of sink
⚒️ Step 5: IRC Plumbing & Installation Requirements
• 	IRC P2705.1: Sinks must be securely mounted and properly connected to water and drain systems
• 	IRC P2601.2: Plumbing systems must be maintained in sanitary condition
if provided, they must meet all IBC/IPC requirements
Laundry rooms often require a service sink for maintenance staff (IBC 2902.3) materials
`
        },
        {
            id: 'sink_laundry_2',
...
📏 Step 4: Accessibility (IBC 1011.5)
...
⚒️ Step 5: IRC Structural & Safety Requirements
• 	IRC R311.7.5-(IBC 1011.5)  Maximum riser height = 7¾"; minimum tread depth = 10"-Variation between risers or treads cannot exceed 3/8 inch
• 	IRC R311.7.8: Handrails required on at least one side of stairs with ≥4 risers
`
        },
        {
...
• 	Floor Deflection Check: Walk across floors to detect soft spots, sagging, or bounce. IBC Section 116 – Unsafe Structures (Critical)
...
IBC Section 116 – Unsafe Structures (Critical)`
        }
    ]
};
...
• 	IBC 716 - IRC R302.11: Chute enclosures must be constructed with fire-resistant materials
• 	IRC R317.1: Moisture-prone areas must use decay-resistant materials
• 	 IBC 713.13 – Refuse & Laundry Chutes (Primary Code Section)
This is the main IBC section governing trash chutes.`
        },
        {
            id: 'trash_2',
            name: 'Chute is clogged',
...
📏 Step 4: tIBC 1202.1 – General Ventilation Requirement (Primary Rule)
IBC 1202.1 requires that all interior spaces, including common areas, must have:
Either:
Natural ventilation per IBC 1202.5
OR Mechanical ventilation per the International Mechanical Code (IMC)
⚒️ Step 5: IRC Ventilation Requirements
• 	IRC R303.3: Bathrooms must have mechanical ventilation or operable windows
• 	IRC M1507.2: Exhaust systems must vent to the outdoors and be sealed
...
• 	IBC 803.11 – Adhesives & Trim
Decorative materials must meet flame‑spread and smoke‑developed limits.
Field takeaway:  
Peeling paint, damaged finishes, or combustible coverings violate Chapter 8. IBC `
        },
        {
            id: 'wall_2',
            name: 'Wall-Interior',
...
⚒️ Step 5: IRC Installation & Safety Requirements
• 	IRC P2801.1–P2803.6:
Water heaters must be listed, properly vented, and installed per manufacturer specs
...
• 	IBC 2801.1 → Must comply with IMC + IPC

IBC 2901.1 → Plumbing installation must meet IPC`
        },
        {
            id: 'water_heater_2',
            name: 'Gas shutoff valve is damaged, missing or not installed',
...
Glass is near walking surfaces
Glass is in the doors or sidelights
Bottom edge is less than 18 inches above the floor
Glass is in a hazardous location (stair landings, ramps, corridors)
🧪 Step 3: Functional Testing
...
• 	IBC 1015 – Guards Required
If the window sill is less than 36 inches above the floor AND the drop outside is ≥ 30 inches, a guard is required.`
        },
        {
            id: 'window_2',
            name: 'Window component is damaged or missing, and the window is not functionally adequate',
