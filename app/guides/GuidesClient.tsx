...
const guides = [
  { title: "First-Time Home Buyer Inspection Guide", desc: "Everything you need to know about home inspections before purchasing your first property.", audience: "Buyers", color: "#0D6A8D" },
  { title: "Seller's Pre-Listing Inspection Checklist", desc: "A step-by-step checklist to prepare your home for sale and maximize its value.", audience: "Sellers", color: "#FF4757" },
  ...
  { title: "Understanding Your Inspection Report", desc: "How to read, interpret, and act on your professional inspection report.", audience: "Everyone", color: "#0D6A8D" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {guides.map((g, i) => (
            <div key={i} className="bg-white border border-gray-100 rounded-[32px] p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group cursor-pointer">
              ...
              <h3 className="text-xl font-bold text-black mb-4 group-hover:text-[#0D6A8D] transition-colors">{g.title}</h3>
              <p className="text-gray-500 text-sm leading-relaxed mb-6">{g.desc}</p>
              <span className="text-[#0D6A8D] font-bold text-sm uppercase tracking-widest flex items-center gap-2">
