...
export default function GuidesClient() {
  ...
  return (
    <main className="w-full min-h-screen bg-white overflow-x-hidden">
      <div className="bg-[#E8F4F8] pt-[-25] pb-4 flex justify-center"><Image src="/logo.png" alt="NSPIREinspection.AI" width={500} height={600} priority className="h-14 md:h-32 lg:h-40 w-auto" /></div>
      ...
      <footer className="bg-black text-white py-12 px-4"><div className="max-w-7xl mx-auto text-center"><Image src="/logo.png" alt="NSPIREinspection.AI" width={120} height={40} className="mx-auto mb-6 h-8 w-auto" /><p className="text-gray-500 text-xs">© 2026 NSPIREinspection.AI. All rights reserved.</p></div></footer>
    </main>
  );
}
