                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-[340px] bg-white rounded-2xl p-6 shadow-sm h-fit">
                            <p className="text-gray-700 text-sm mb-5">
                                All NSPIREinspection.AI members listed on this site are NSPIREinspection.AI
                                Certified Professional Inspectors and meet/abide by
                                NSPIREinspection.AI&apos;s strict standards.
                            </p>
                            <p className="font-bold text-gray-900 mb-3">All NSPIREinspection.AI CPIs:</p>
                            <ul className="space-y-2 text-sm text-gray-700">
                                <li>✓ Must pass the NSPIREinspection.AI Online Inspector Exam</li>
                                <li>✓ Must meet pre-certification training requirements</li>
                                <li>✓ Must abide by the NSPIREinspection.AI standards of practice</li>
                                <li>✓ Must abide by the NSPIREinspection.AI code of ethics</li>
                                <li>✓ Must meet NSPIREinspection.AI&apos;s continuing education policy, including 24 hours of education each year</li>
                            </ul>
                        </div>
                        ...
                        <div className="flex-1 bg-white rounded-2xl shadow-sm overflow-hidden">
                            ...
                            {inspectors.map((inspector, idx) => (
                                <div
                                    key={idx}
                                    className={`grid grid-cols-3 items-center px-6 py-4 hover:bg-gray-50 transition-colors cursor-pointer group ${idx !== inspectors.length - 1 ? "border-b border-gray-100" : ""
                                        }`}
                                >
                                    <div>
