...
const services = [
  {
    ...
    description: "NSPIREinspection.AI’s Buyer Inspection Services support confident purchasing decisions for residential, multi-family, commercial, and public housing properties across the USA. Our inspections include multi-unit buyer inspection, single-family home buyer inspection, condominium and townhome buyer inspection, and commercial property pre-purchase evaluation. We conduct comprehensive property condition assessments for buyers, covering structural, mechanical, and electrical review while identifying hazards and compliance risks. Each buyer inspection includes NSPIREinspection.AI buyer safety compliance checks, repair and maintenance cost estimation, and buyer decision support reports.",
    moreText: "Buyer Risk Analysis, Compliance, and Negotiation Support: Our buyer-focused inspections emphasize hazard and risk identification, safety compliance, and financial clarity. NSPIREinspection.AI delivers buyer decision support reports that highlight structural deficiencies, system failures, and safety concerns affecting value and insurability.",
  ...
  },
  {
    ...
    description: "NSPIREinspection.AI’s Owner Inspection Services help property owners maintain asset value, ensure compliance, and plan preventive maintenance. Our annual owner property inspection, multi-unit owner inspection, and building health and maintenance evaluation identify issues before they escalate. We perform property condition assessments (PCA), insurance risk checks for owners, and tenant safety and habitability reviews.",
    moreText: "Preventive Maintenance and Owner Compliance Reporting: Our owner inspections focus on actionable intelligence, including pre-renovation inspections and owner repair priority reports. NSPIREinspection.AI evaluates structural integrity, MEP systems, and safety features to identify early-stage deterioration.",
  ...
  },
  {
    ...
    description: "NSPIREinspection.AI’s Seller Inspection Services prepare properties for listing with transparency and confidence. Our pre-listing inspection, multi-unit seller inspection, and property readiness evaluation identify major and minor defects before marketing. We provide HUD/REAC pre-sale support, repair and upgrade recommendations, and pricing advantage inspection reports. Marketability enhancement reviews focus on safety, compliance, and presentation factors that influence buyer perception.",
    moreText: "Seller Transparency and Pricing Advantage Reports: Seller inspections include detailed seller transparency reports designed to minimize post-offer disputes. NSPIREinspection.AI documents defects, compliance gaps, and improvement opportunities with clear prioritization.",
  ...
  },
  {
    ...
    description: "NSPIREinspection.AI delivers comprehensive rental property inspection services, including move-in inspection, move-out inspection, annual rental safety inspection, and habitability standards review. We assess tenant damage, occupancy health and safety, and multi-unit rental inspection requirements. NSPIREinspection.AI rental compliance and HUD/REAC pre-audit support ensure landlords meet federal and local housing standards.",
    moreText: "Rental Risk Management and Documentation Support: Our rental inspections focus on risk mitigation and regulatory readiness. NSPIREinspection.AI evaluates life-safety systems, habitability conditions, and compliance gaps that impact leasing and audits.",
  ...
  },
  {
    ...
    description: "NSPIREinspection.AI provides commercial building inspection services for multi-unit commercial facilities, industrial properties, office buildings, retail spaces, warehouses, and shopping centers. Our inspections include construction quality assessment, safety and code compliance, fire and life safety checks, and roof, HVAC, electrical, and plumbing analysis.",
    moreText: "Commercial Compliance, Systems, and Structural Evaluation: Commercial inspections emphasize operational continuity and regulatory alignment. NSPIREinspection.AI identifies deficiencies affecting safety, insurability, and asset performance. Our reporting supports capital planning, compliance remediation, and insurance coordination.",
  ...
  },
  {
    ...
    description: "NSPIREinspection.AI specializes in public housing inspection services aligned with NSPIREinspection.AI standards. We provide HUD/REAC inspection preparation, multi-family housing inspection, apartment community compliance, and federal housing standards review. Our habitability and safety evaluations, energy and environmental standards checks, and occupancy health inspections support REAC scoring improvement and regulatory readiness for public housing authorities (PHAs).",
    moreText: "Public Housing Risk, Compliance, and Documentation: Our public housing inspections deliver risk and deficiency reporting with clear remediation guidance. NSPIREinspection.AI supports PHAs with documentation, compliance verification, and audit preparation.",
  ...
  },
  {
    ...
    description: "NSPIREinspection.AI’s insurance risk management inspections address property risk assessment, hazard and liability review, and multi-unit insurance inspection requirements. We conduct commercial insurance inspections, fire and safety risk reporting, and environmental risk analysis. Our foundation, electrical, and structural risk reviews support insurance claim prevention and pre-coverage inspection needs.",
    moreText: "Insurance Compliance and Claim Prevention Reporting: Insurance-focused inspections emphasize loss prevention and underwriting readiness. NSPIREinspection.AI provides annual insurance compliance checks and actionable recommendations to reduce exposure.",
    image: "/blog-roof.png",
    color: "bg-teal-50",
  ...
  },
  {
    ...
    description: "NSPIREinspection.AI offers specialized inspection services, including sewer scope video inspections, pool and spa inspections, mold sampling, roof inspection, and foundation and crawlspace inspection. We also provide luxury home inspections, historic homes inspections, Malibu and beach home inspections, and general home inspections. Commercial add-on inspections and multi-unit specialized evaluations extend our capabilities across property types.",
    moreText: "Environmental, Air Quality, and Advanced Evaluations: Our environmental and air quality sampling services address health, safety, and regulatory concerns. NSPIREinspection.AI evaluates indoor air quality, moisture intrusion, and environmental risks affecting occupancy and compliance.",
...
const processSteps = [
  ...
  { num: "Step 3", title: "Compliance & Risk Review", desc: "Inspection results are reviewed against NSPIREinspection.AI, HUD, REAC, and local codes to identify hazards, code violations, and compliance risks." },
        ...
        <main className="flex-1 w-full">
          ...
          <section className="bg-[#E8F4F8] py-20 md:py-32 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
              ...
              <div className="text-gray-600 text-lg md:text-xl max-w-4xl mx-auto mb-8 leading-relaxed space-y-6">
                <p>
                ...
                <div className="bg-white/60 p-6 rounded-2xl backdrop-blur-sm mx-auto max-w-3xl border border-white/20 shadow-sm">
                  <p className="text-sm md:text-base leading-relaxed text-gray-700">
                    From single-family homes to multi-unit commercial buildings, NSPIREinspection.AI combines structural, mechanical, electrical, and safety evaluations under one trusted framework. We support purchase decisions, risk management, compliance verification, and long-term asset planning through data-driven inspections.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-20 px-4 md:px-8 bg-white">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">The NSPIREinspection.AI Inspection Process</h2>
                <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed">
                  Our inspection process is designed for clarity, efficiency, and compliance, ensuring every client receives accurate, actionable insights. NSPIREinspection.AI’s step-by-step workflow minimizes risk, maximizes property understanding, and supports informed decision-making for buyers, owners, sellers, landlords, and commercial operators nationwide.
                </p>
              </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
              <div>
                ...
                <p className="text-gray-300 mb-6 leading-relaxed">
                  NSPIREinspection.AI prioritizes regulatory compliance, quality, and safety, ensuring every inspection meets federal, state, and local standards. Our certified inspectors follow NSPIREinspection.AI, HUD, REAC, and industry-specific guidelines, delivering trustworthy results. Adherence to these standards mitigates liability, supports insurance requirements, and protects asset value.
                </p>
              ...
              <div>
                ...
                <p className="text-gray-300 mb-6 leading-relaxed">
                  NSPIREinspection.AI delivers comprehensive, actionable reports for all inspections. Reports include detailed property condition summaries, hazard identification, repair cost estimates, and NSPIREinspection.AI compliance status. Clients receive photos, annotated diagrams, and executive summaries to support negotiations, insurance claims, and long-term maintenance planning.
                </p>
