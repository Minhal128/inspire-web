  ...
  return (
    ...
    <div className="flex flex-row gap-3 mt-6 flex-wrap">
      ...
      <a
        ...
        className="flex items-center gap-3 bg-black text-white px-4 py-3 rounded-xl hover:bg-gray-900 transition-all hover:scale-105 cursor-pointer"
      >
    ...
    <section className="bg-[#E8F4F8] py-16 md:py-24 text-center">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <h2 className="text-3xl md:text-5xl font-extrabold mb-16">
          <span className="text-white drop-shadow-md">Download</span> <span className="text-[#006795]">INSPIRE Inspection.Ai APP</span>
        </h2>
