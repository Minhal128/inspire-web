      ...
      <article className="max-w-[1000px] mx-auto px-4 md:px-6 pt-12 md:pt-20">
        <header className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <span className="bg-[#E8F4F8] text-[#0D6A8D] px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest">For Professionals</span>
        ...
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-8">
          <p className="text-xl font-medium text-gray-900 border-l-4 border-[#0D6A8D] pl-6">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              {[
                ...
                <div key={i} className="bg-[#E8F4F8]/50 p-6 rounded-3xl border border-[#0D6A8D]/10">
                  <h3 className="font-bold text-[#0D6A8D] mb-2">{item.title}</h3>
          ...
          <section>
            ...
            <ul className="space-y-4">
              <li className="flex gap-4 items-start">
                <div className="mt-1 bg-[#0D6A8D] rounded-full p-1"><svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg></div>
          ...
          <section className="py-12 text-center bg-[#F8F9FA] rounded-[40px]">
            ...
            <Button className="bg-[#0D6A8D] hover:bg-[#0A5F7F] text-white rounded-full px-12 py-6 text-lg font-bold shadow-xl">Contact Our Pro Team</Button>
          </section>
        </div>
