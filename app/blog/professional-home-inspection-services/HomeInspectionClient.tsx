    ...
    <main className="w-full min-h-screen bg-white overflow-x-hidden">
      ...
      <article className="max-w-[1000px] mx-auto px-4 md:px-6 pt-12 md:pt-20">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-8">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#F8F9FA] p-6 rounded-3xl">
                <h3 className="font-bold text-[#0D6A8D] mb-2">Discover Hidden Problems</h3>
              ...
              <div className="bg-[#F8F9FA] p-6 rounded-3xl">
                <h3 className="font-bold text-[#0D6A8D] mb-2">Support Negotiations</h3>
          ...
          <section className="bg-[#0D6A8D] text-white p-8 md:p-12 rounded-[40px]">
