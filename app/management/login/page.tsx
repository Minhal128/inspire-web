  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="w-full bg-[#E8F4F8] px-6 text-center flex flex-col items-center justify-center rounded-b-[70px]" style={{ height: '280px' }}>
        ...
        <p className="text-xs md:text-sm text-[#0D6A8D] font-semibold mt-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-sm text-[#0D6A8D] hover:underline font-medium bg-transparent border-0 cursor-pointer"
              >
                Forgot Password?
              </button>
            </div>
