            ...
            {properties.map((property) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  ...
                  <Button
                    onClick={() => router.push(`/asset-manager/dashboard/inspection/unit-selection?property=${property.id}`)}
          ...
          {propertyId && (
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6">
                {units.map((unit) => (
                  <Card
                    ...
                    onClick={() => router.push(`/asset-manager/dashboard/inspection/${unit.id}`)}
                  >
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Button
                  onClick={() => router.push('/asset-manager/dashboard/inspection/summary')}
                ...
                <Button
                  onClick={() => router.push('/asset-manager/dashboard')}
