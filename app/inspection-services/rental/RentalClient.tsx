    ...
    <MainLayout>
      <div className="w-full min-h-screen bg-white overflow-x-hidden">
        ...
        <section className="relative bg-gradient-to-br from-[#10B981] to-[#059669] py-24 md:py-36 overflow-hidden">
          <div className="absolute inset-0 opacity-20"><Image src="/plaza_shops.png" alt="" fill className="object-cover" /></div>
