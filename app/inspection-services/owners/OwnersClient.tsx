            ...
            <div className="flex flex-col md:flex-row-reverse gap-10 items-center">
              <div className="flex-1">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Our owner inspections focus on actionable intelligence, including pre-renovation inspections and owner repair priority reports. NSPIREinspection.AI evaluates structural integrity, MEP systems, and safety features to identify early-stage deterioration. Preventive maintenance reports reduce emergency repairs and extend asset lifespan. Compliance reviews address local codes, insurance requirements, and NSPIREinspection.AI standards. By integrating risk assessment with maintenance planning, NSPIREinspection.AI supports sustainable ownership strategies for residential, multi-family, and commercial properties throughout the USA.
                </p>
              </div>
              <div className="flex-shrink-0 w-full md:w-[400px] h-[280px] rounded-[32px] overflow-hidden relative">
                <Image src="/candid_inspection.png" alt="Owner inspection" fill className="object-cover" />
              </div>
            </div>
          </div>
        </section>
